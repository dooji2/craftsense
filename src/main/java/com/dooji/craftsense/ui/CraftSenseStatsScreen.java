                ...
                for (int py = minY; py <= maxY; py++) {
                    ...
                    if (dx * dx + dy * dy <= radius * radius) {
                        ...
                        if (rx >= 0 && rx < pieImage.getWidth() && ry >= 0 && ry < pieImage.getHeight()) {
                            pieImage.setColorArgb(rx, ry, color);
                        }

                        int darkColor = darken(color, 0.5f);
                        for (int t = 1; t <= thickness; t++) {
                            int wallY = ry + t;
                            if (wallY >= 0 && wallY < pieImage.getHeight()) {
                                pieImage.setColorArgb(rx, wallY, darkColor);
                            }
                        }
                    }
                }
            ...
            for (int py = minY; py <= maxY; py++) {
                ...
                if (dx * dx + dy * dy <= radius * radius) {
                    ...
                    if (rx >= 0 && rx < image.getWidth() && ry >= 0 && ry < image.getHeight()) {
                        image.setColorArgb(rx, ry, color);
                    }
                    ...
                    for (int t = 1; t <= thickness; t++) {
                        ...
                        if (wallY >= 0 && wallY < image.getHeight()) {
                            image.setColorArgb(rx, wallY, darkColor);
                        }
                    }
                }
            }
